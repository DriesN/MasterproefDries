...
x0 = [0.003, 10e6, 0.000008, 1e8, 0.0145, -0.1726,0.7, 0.00004 , 10e6, 21, 21, 6 , 0.7];
lb = [0.001, 1e6 , 0.000007, 9e7, 0.01  , -0.2   ,0.5, 0.000007, 1e6 , 20, 20, 5 , 0.6];
ub = [0.004, 9e7 , 0.00005 , 1e9, 0.1   , 0      ,1  , 0.00005 , 9e7 , 26, 26, 10, 0.9];
