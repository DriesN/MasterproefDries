...
x0 = [0.003, 10e6,0.00005, 1e8, 0.0145 , -0.1726,0.7, 0.00005, 10e6, 21, 21, 6 ,0.7];
lb = [0.001, 1e6 ,0.00001, 9e7, 0.014  , -0.18  ,0.5, 0.00001, 1e6 , 20, 20, 5 ,0.6];
ub = [0.004, 1e8 ,0.00009, 1e9, 0.015  , -0.17  ,1  , 0.00009, 1e8 , 26, 26, 10,0.8];
